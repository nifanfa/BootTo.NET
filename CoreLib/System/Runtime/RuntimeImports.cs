...
namespace System.Runtime
{
    internal static class RuntimeImports
    {
        ...
        */
        ...
        internal static unsafe object RhNewObject(EETypePtr pEEType) => InternalCalls.RhpNewFast(pEEType.EEType);

        internal static unsafe void RhBulkMoveWithWriteBarrier(ref byte dmem, ref byte smem, uint size)
        {
