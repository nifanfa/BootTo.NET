...
{
	QG_LARGE_LOCAL edge_t	ledges[NUMSTACKEDGES +
				((CACHE_SIZE - 1) / sizeof(edge_t)) + 1];
	QG_LARGE_LOCAL surf_t	lsurfs[NUMSTACKSURFACES +
...
{
	QG_LARGE_LOCAL byte	warpbuffer[WARP_WIDTH * WARP_HEIGHT];
...
void R_RenderView (void)
{
	...
	delta = (intptr_t)&dummy - (intptr_t)r_stack_start;
